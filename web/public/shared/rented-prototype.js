...
(function (global) {
  ...
  /* Next serves public/*.html as pages, not assets, so the markup ships under
     a second, inert extension the router does not claim. */
  ...
  function loadPartial() {
    if (!partialRequest) {
      partialRequest = fetchPartial(PARTIAL_URL);
    }
