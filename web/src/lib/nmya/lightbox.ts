/**
 * Lightbox, ported from
 * national-muslim-youth-association/muslim-youth-website/case-study-script.js.
 * Same two branches as OTRS's: NMYA enlarges the four detail shots and the two
 * growth charts. The hero is a video, so it is not a target.
 */

const IMAGE_SELECTOR = ".paper-cs__shot img";
