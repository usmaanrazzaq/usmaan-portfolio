/**
 * Lightbox, ported from adsum/case-study-script.js. Adsum is the only case
 * study that enlarges both media and charts, so this keeps both branches of
 * the original: Rented's overlay carries a chart slot, WCM's an image, and
 * Adsum's carries both.
 */

const IMAGE_SELECTOR =
  ".paper-cs__hero img, .paper-cs__shot img, .paper-cs__carousel-slide img";
